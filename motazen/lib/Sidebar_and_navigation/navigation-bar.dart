  ...
  child:   Container(
    ...
    child:  Padding(
      ...
      child: GNav(
          ...
          activeColor: const Color(0xFFFFFFFF), // selected icon and text color
          iconSize: 24, // tab button icon size
          tabBackgroundColor: const Color(0xFF66BF77), // selected tab background color
          ...
          tabs: const [
            ...
            GButton(
              ...
              text: 'عاداتي وأهدافي',
              //  onPressed: () {
              //        Navigator.push(context, MaterialPageRoute(builder: (this.context) {return const Goals_habit (isr: IsarService());}
              //        ));
              //        }
            ),
            GButton(
