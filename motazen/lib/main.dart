...
Future main() async {
  ...
  iser.openIsar();
  runApp(const goals_habit());
  
  // runApp(ChangeNotifierProvider<WheelData>(create: 
  // (_)=>WheelData(),
  //  child: MaterialApp(home: fetchAspect(iser: iser )))); // my widget // the one where i will create the quastion list .
}
