              ...
              actions: [
                IconButton(
                    ...
                    onPressed: ()  {
                         ...
                         Navigator.push(context, MaterialPageRoute(builder: (context) {return GoalListScreen(isr: widget.isr);
...
Row(children: [
  Container(
    child: Text("اسم الهدف:",style: TextStyle(fontSize: 23),),
  ),
  SizedBox(width: 10,),
  Container(
    child: Text(displayGoalNameControlller.text,style: TextStyle(fontSize: 22 ,color: Colors.black54),),
  )
],),
SizedBox(
      height: 20,
...
Row(children: [
  Container(
    child: Text("جانب الحياة:",style: TextStyle(fontSize: 23),),
  ),
  SizedBox(width: 10,),
  Container(
    child: Text(goalAspect,style: TextStyle(fontSize: 22 ,color: Colors.black54),),
  )
],),
SizedBox(
      height: 20,
...
Row(children: [
  Container(
    child: Text("تاريخ الاستحقاق:",style: TextStyle(fontSize: 23),),
  ),
  SizedBox(width: 10,),
  Container(
    child: Text(dueDataDescription,style: TextStyle(fontSize: 22 ,color: Colors.black54),),
  )
],),
SizedBox(
      height: 20,
...
Row(children: [
  Container(
    child: Text("الفترة:",style: TextStyle(fontSize: 23),),
  ),
  SizedBox(width: 10,),
  Container(
    child: Text(goalDurationDescription,style: TextStyle(fontSize: 22 ,color: Colors.black54),),
  )
],),
SizedBox(
      height: 20,
...
Row(children: [
  Container(
    child: Text("الأهمية:",style: TextStyle(fontSize: 23),),
  ),
  SizedBox(width: 10,),
  Container(
    child: Text(goalImportanceDescription,style: TextStyle(fontSize: 22 ,color: Colors.black54),),
  )
],),
  ],
),
